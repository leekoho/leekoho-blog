<template lang="html">
  <div id="triangle-generator" class="container">
    <header>
      <h1 class="title is-1">CSS三角形生成器</h1>
    </header>
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control not-rotate">
                    <label v-for="dir in specialDir" :for="dir" class="radio" :style="setDirectionPositionStyle(dir)"
                  ...
                  <div class="control rotate">
                    <label v-for="dir in normalDir" :for="dir" class="radio" :style="setDirectionPositionStyle(dir)"
                           :class="{active: dir === direction}">
                      <input type="radio" name="direction" :id="dir" :value="dir" v-model="direction">
                    </label>
                  </div>
            ...
            <div class="field is-horizontal align-center">
              ...
              <div class="field-body">
                <div class="field has-addons">
                  ...
                  <p class="control"><span class="button">px</span>
                  </p>
                </div>
              </div>
            </div>
